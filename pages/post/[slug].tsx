    ...
    <main>
      ...
      <article className="mx-10 lg:mx-36">
        ...
        <div className="">
          ...
          content={post.body}
          className=''
          serializers={ // react portable text
            {
              h1: (props: any) => (
...
<form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
        ...
        <label className="block mb-5">
          ...
          className='shadow border rounded py-2 px-3 form-input mt-1 block outline-none focus:ring w-full ring-yellow-500' 
          type="email" 
          placeholder="bigticket@gmail.com" />
        </label>
        ...
        <label className="block mb-5">
          ...
          {/* errors.name will return when field validation fails */}
